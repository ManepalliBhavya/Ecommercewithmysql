	...
	<section class="container sproduct my-5 pt-5">
		<div class="row mt-5">
			<div class="col-lg-5 col-md-12 col-12">
				<a
					href="${pageContext.request.contextPath }/userProductdetails/${productuser.id }"><img
					src="/uploads/${productuser.fileName}" id="MainImg" width="100%"/></a>

				<div class="small-img-group">
					<div class="small-img-col">
						<img src="/uploads/${productuser.fileName}" width="100%"
							class="small-img" alt="" />
					</div>
					<div class="small-img-col">
						<img src="/uploads/${productuser.imageName1}" width="100%"
							class="small-img" alt="" />
					</div>
					<div class="small-img-col">
						<img src="/uploads/${productuser.imageName2}" width="100%"
							class="small-img" alt="" />
					</div>
					<div class="small-img-col">
						<img src="/uploads/${productuser.imageName3}" width="100%"
							class="small-img" alt="" />
					</div>
				</div>
			</div>
			...
			<div class="col-lg-6 col-md-12 col-12">
				<h1>${productuser.proName}</h1>
				<h2>Rs.${productuser.price}</h2>

				<input type="number" value="1"> <a
					href="${pageContext.request.contextPath }/welcomeOrderPage/${productuser.id }"><input
					type="button" value="PlaceOrder"
					style="background-color: #ff7f50; width: 20%; border: none; cursor: pointer"></input></a>
				<h4 class="mt-5 mb-4">Product Description</h4>
				<p>${productuser.proDesc}</p>
			</div>
		</div>
	</section>
