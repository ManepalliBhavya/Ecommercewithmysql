	...
	<form:form method="post" action="/updateSupplier"
		...
		<div class="container">
			<div class="card w-50 mx-auto my-5">
				<div class="card-header text-center">Update Supplier</div>
				<div class="card-body">
					...
					<div class="form-group">
						...
						<form:input path="suppName" class="form-control"
							placeholder="Enter supplier name" />

					</div>
					<div class="form-group">
						<label>supplier city:</label>
						<form:input path="suppCity" class="form-control"
							placeholder="Enter supplier city" />
					</div>
					<div class="form-group">
						<label>supplier phone: </label>
						<form:input path="suppPhone" class="form-control"
							placeholder="Enter supplier phone" />
					</div>
					<div class="text-center">
						<input type="submit" id="submit"
							class="btn btn-lg btn-primary btn-block" value="Update"  onclick="clickMe(this)"/>
					</div>
				</div>
			</div>
		</div>
...
<script>
	function clickMe(e){
    alert("Supplier Updated succssfully");
	}
</script>
