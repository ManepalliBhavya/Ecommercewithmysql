...
<body>
	...
	<nav
		...
		<form action="indexSupplier">
			<div class="input-group mb-0">
				<input type="search" placeholder="Search here..." name="suppName"
					value="${suppName}" aria-describedby="button-addon5"
					class="form-control">
...
<br>
	...
	<div class="row mx-auto container-fluid">
		<c:forEach var="supplier" items="${supplierList}">
			<div class="supplier text-center col-lg-3 col-md-4 col-12">
				<h5 class="suppName">
					<c:out value="${supplier.suppName}" />
				</h5>
				<h5 class="suppCity">
					<c:out value="${supplier.suppCity}" />
				</h5>
				<h5 class="suppPhone">
					<c:out value="${supplier.suppPhone}" />
				</h5>
				<td><a
					href="${pageContext.request.contextPath }/supplierupdate/${supplier.id }">
    ...
    border: none;cursor:pointer;padding: 10px;color: #ffffff;" ></input>
				...
				<td><a
					href="${pageContext.request.contextPath }/supplierdelete/${supplier.id }"
